...
public class Metodos_Clientes {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public int ActualizarClientes(String Id, String Nombres, String Apellidos, String Sexo, String Cedula, String Telefono, String Ruc, String Email, String Direccion) {
        String SQL = "UPDATE cliente SET Nombre = '" + Nombres + "', Apellido = '" + Apellidos + "', Sexo = '" + Sexo + "', Cedula = '" + Cedula + "', Telefono = '" + Telefono + "', Ruc = '" + Ruc + "',  Email = '" + Email + "',  Direccion = '" + Direccion + "' WHERE idCliente = " + Id;
        int resultado = 0;
    ...
    //********************************************************************************************
    public int guardarClientes(String Nombres, String Apellidos, String Sexo, String Cedula, String Telefono, String Ruc, String Email, String Direccion) {
        int resultado = 0;
        Connection conexion = null;

        String sentencia_guardar = "INSERT INTO cliente (Nombre, Apellido, Sexo, Cedula, Telefono, Ruc, Email, Direccion) VALUES (?,?,?,?,?,?,?,?)";
...
//--------------------------------------------------------------------------------
    public int ClienteExistente(String cedula) {
        Connection conexion = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(idCliente) FROM cliente WHERE Cedula = ? ";
