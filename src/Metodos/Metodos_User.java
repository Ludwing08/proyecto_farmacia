...
public class Metodos_User {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public int ActualizarUsuarios( String idUsuario,  String Nombres, String Apellidos,String Cedula, String Email, String Usuario, String Contraseña, String TipoUsuario, String Estado) {
        String SQL = "UPDATE usuario SET Nombre = '" + Nombres + "', Apellido = '" + Apellidos + "', Cedula = '" + Cedula + "', Email = '" + Email + "', Usuario = '" + Usuario + "', Contraseña = '" + Contraseña + "', TipoUsuario = '" + TipoUsuario + "', Estado = '" + Estado +"' WHERE idUsuario = " + idUsuario;
        int resultado = 0;
    ...
    //********************************************************************************************
    public int guardarUsuarios(String Nombres, String Apellidos, String Cedula, String Email, String Usuario, String Contraseña, String TipoUsuario, String Estado) {
        int resultado = 0;
        Connection conexion = null;

        String sentencia_guardar = "INSERT INTO usuario (Nombre, Apellido, Cedula, Email, Usuario, Contraseña, TipoUsuario, Estado) VALUES (?,?,?,?,?,?,?,?)";
...
//--------------------------------------------------------------------------------
    ...
    public static String buscarNombre(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
...
public static String buscarId(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
    ...
    public static String buscarCedula(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
    ...
    public static String buscarEmail(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Email, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
     ...
     public static String buscarUsuario(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Email, Usuario, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
     ...
     public static String buscarContraseña(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Email, Usuario, Contraseña, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
     ...
     public static String buscarTipoUsuario(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Email, Usuario, Contraseña, TipoUsuario, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
     ...
     public static String buscarEstado(String nusuario) {
        ...
        try {
            conexion = ConexionBD.conectar();
            String sentencia_buscar = ("SELECT idUsuario, Cedula, Email, Usuario, Contraseña, TipoUsuario, Estado, Nombre, Apellido FROM usuario WHERE Usuario = '" + nusuario + "'");
            sentencia_preparada = conexion.prepareStatement(sentencia_buscar);
            resultado = sentencia_preparada.executeQuery();
            if (resultado.next()) {
