...
public class Metodos_Productos {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public int ActualizarDatos(String ID, String Nombre, String Concentracion, int Stock, float Costo, float Precio, String RegistroSanitario, Date Fecha, String Estado, String Presentacion, String Laboratorio) {
        String SQL = "UPDATE producto SET Nombre = '" + Nombre + "',Concentracion = '" + Concentracion + "', Stock = '" + Stock + "', Costo = '" + Costo + "', Precio_Venta = '" + Precio + "', RegistroSanitario = '" + RegistroSanitario + "', FechaVencimiento = '" + Fecha + "', Estado = '" + Estado + "', idPresentacion = '" + Presentacion + "', idLaboratorio = '" + Laboratorio + "' WHERE idProducto = " + ID;
        int resultado = 0;
    ...
    //********************************************************************************************
    public int guardarProductos(String Nombre, String Concentracion, int Stock, float Costo, float Precio, String RegistroSanitario, Date Fecha, String Estado, String Presentacion, String Laboratorio) {
        int resultado = 0;
        Connection conexion = null;

        String sentencia_guardar = "INSERT INTO producto (Nombre, Concentracion, Stock, Costo, Precio_Venta, RegistroSanitario, FechaVencimiento, Estado, idPresentacion, idLaboratorio) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public DefaultTableModel getDatos() {
        ...
        String MYSQL_SELECT = "SELECT p.idProducto,pr.Descripcion AS presentacion,p.Nombre,p.Concentracion,p.Stock,p.Costo,p.Precio_Venta,p.FechaVencimiento,p.RegistroSanitario,l.Nombre as laboratorio,p.Estado "
...
//--------------------------------------------------------------------------------
    ...
    public DefaultTableModel CargarDatosBusqueda() {
        ...
        String MYSQL_SELECT = "SELECT p.idProducto,pr.Descripcion AS presentacion,p.Nombre,p.Concentracion,p.Stock,p.Costo,p.Precio_Venta "
    ...
    public DefaultTableModel CargarDatosBusquedaCompra() {
        ...
        String MYSQL_SELECT = "SELECT p.idProducto,pr.Descripcion AS presentacion,p.Nombre,p.Concentracion,p.Stock,p.Costo "
                + "FROM producto AS p INNER JOIN presentacion AS pr ON p.idPresentacion=pr.idPresentacion WHERE P.Estado='Activo' ";
        try {
            TitulosCompra();
            CN = ConexionBD.conectar();
