...
public class frmCompras extends javax.swing.JInternalFrame {
    ...
    void CalcularIGV(){
        ...
        simbolos.setDecimalSeparator('.');
        DecimalFormat formateador = new DecimalFormat("####.##",simbolos);       
        iva=Double.parseDouble(txtSubTotal.getText())*0.12;
        txtIGV.setText(String.valueOf(formateador.format(iva)));
    }
...
//        txtConcentracionProducto.setText("");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //+++++++++++++++++++++++
        if (num == 0) {
            compras.GuardarCompras(Fecha, SubTotal, Total, IVA, Estado, IdProveedor, IdEmpleados, IdTipoComprobante);
            guardarDetalle();
        }
            mirar();
            limpiarTabla();
