...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        if (txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty()) {
            ...
            String buscarFarmaceutico = metodos.UsuarioFarmaceutico(txtUsuario.getText(), txtContraseña.getText());
            String buscarBodeguero = metodos.UsuarioBodeguero(txtUsuario.getText(), txtContraseña.getText());
            ...
            } else if (buscarFarmaceutico.equals("USUARIO ENCONTRADO")) {
                String busqueda_nombre = metodos.buscarNombre(txtUsuario.getText());
                JOptionPane.showMessageDialog(this, "Bienvenido(a): \n" + busqueda_nombre + "\nRol: Farmaceutico", "Ingreso Exitoso",
...
//                frmClientes.btnImprimir.setVisible(false);
            ...
            } else if (buscarBodeguero.equals("USUARIO ENCONTRADO")) {
                String busqueda_nombre = metodos.buscarNombre(txtUsuario.getText());
                JOptionPane.showMessageDialog(this, "Bienvenido(a): \n" + busqueda_nombre + "\nRol: Bodeguero", "Ingreso Exitoso",
                        JOptionPane.PLAIN_MESSAGE, icono("/Iconos/Vend1.png", 60, 60));
                frmPrincipal ventana = new frmPrincipal();
...
//                frmClientes.btnImprimir.setVisible(false);
                ...
                frmPrincipal.mnuComprobante.setVisible(false);
                //frmPrincipal.mnuCompra.setVisible(false);
                frmPrincipal.mnuVenta.setVisible(false);
                frmPrincipal.mnuClientes.setVisible(false);
            } else {
    ...
    private void btnIngresarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnIngresarKeyPressed
        if (txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty()) {
            ...
            String busqueda_usuario = metodos.buscarUsuarioRegistrado(txtUsuario.getText(), txtContraseña.getText());
            String buscarUsuario = metodos.UsuarioFarmaceutico(txtUsuario.getText(), txtContraseña.getText());
